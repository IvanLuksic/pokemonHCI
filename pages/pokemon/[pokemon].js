...
export default function Pokemon() {
     ...
     const abilities= [{heading: "Punch", text: "punch lorem lorem lorem"}, {heading: "Punch", text: "punch lorem lorem lorem"},{heading: "Punch", text: "punch lorem lorem lorem"}, {heading: "Punch", text: "punch lorem lorem lorem"}, {heading: "Punch", text: "punch lorem lorem lorem"}, {heading: "Punch", text: "punch lorem lorem lorem"}, {heading: "Punch", text: "punch lorem lorem lorem"}]
           ...
           <ContentContainer>
               <Grid container direction="row" justifyContent="center" alignItems="center" mb="3em">
                    ...
                    <Grid item xs={12} id="back-to-top-anchor">
                        <Paper elevation={0} sx={{textAlign: "center", background: `linear-gradient(to top, ${TypeToColor[types[1]]},50%, transparent)`}}>
                                <Image src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/${router.query.pokemon}.svg`} width={300} height={300} alt={router.query.pokemon} />
                        </Paper>
                    </Grid>
                    <Grid item xs={11} md={6}>
                        <Typography variant="h3" ml="1em" sx={{fontWeight: 600}}>{/*(PokemonList[router.query.pokemon - 1].name*/}</Typography>
                    ...
                    <Grid item xs={11}>
                        <Grid container direction="row" justifyContent="center" alignItems="center" spacing={4}>    
                            <PokemonInfoContainer heading="Abilities">
                                {abilities.map(ability => <PokemonICCard key={ability.heading} heading={ability.heading} text={ability.text}/>)}
