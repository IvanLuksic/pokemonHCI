...
export default function AuthorImage({ title, url }) {
    ...
    return (
        <Paper elevation={3} sx={{ width: "100%", aspectRatio: "1", borderRadius: "50%", border: 3, borderColor: theme.palette.primary.main, overflow: "hidden"}}>
            <Grid container direction="row" item xs sx={{width: "100%", aspectRatio: "1", position: "relative", justifyContent: "center", alignItems: "center", textAlign: "center", lineHeight: "500%"}}>
