...
export default function Cart({cartItems, setCartItems}) {
    ...
    return (
        <Grid item xs={12} sx={{position: 'fixed',width:'17.5%', right: 10, top: 100, display: {md: 'block', sm: 'none', xs: 'none'}}}>
            <Paper sx={{width: '100%',backgroundColor: "#f5f5f5", borderRadius: 5, border: "2px solid", borderColor: "primary.main"}}>
